...
public class Restaurant extends JFrame {
	...
	private static CookFactory cookFactory;
...
//		addComboBox(jp, jlNumTablesPerBusboy, jcbNumTablesPerBusboy, 2, 1);
		...
		addComboBox(jp, jlNumCooks, jcbNumCooks, 2, 0);
		...
		jbRestaurant.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				if (jbRestaurant.getText().equals("Start Restaurant")) {
					...
					//added functionality to reset label values as well
					resetLabelValues();
...
//					addMessage("Number of tables per busboy: " + getNumTablesPerBusboy());
					addMessage("Number of cooks: " + getNumCooks());
			...
			/**
			 * added functionality to clear out old values when restaurant restarted
			 */
			private void resetLabelValues() {
				waitingCustomerLabel.resetValues();
				seatedCustomerLabel.resetValues();
				servedCustomerLabel.resetValues();
				closedTablesJLabel.setText("Closed Tables: ");
				openTablesJLabel.setText("Open Tables: ");
			}
		});
